...
public class LoginPage extends BasePage{
    ...
    public void verifyWithPopUpMessage_Method(String expectedMessage){
        ...
        Alert alert= Driver.get().switchTo().alert(); //bu sekilde acilan ve locator olmayan pencerenin icindeki text alabiliyoruz.
    ...
    @FindBy(xpath = "//a[@id='itemc']") //3 element tutuyor
    public List<WebElement> categorieList_Loc;
